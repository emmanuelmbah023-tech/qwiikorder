...
import { CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, InputLabel, MenuItem, Select, TextField, Typography } from "@mui/material";
     ...
     return(
        <main className="min-h max-w-xl mx-auto my-10 px-6 py-8 bg-white shadow-lg rounded-xl">
            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    <Typography>order Placed sucessfully</Typography>
                </DialogContent> 
                <DialogActions>
                    <Button  on click={handleClose}  color="primary" variant="contained" autoFocus>
                        close
